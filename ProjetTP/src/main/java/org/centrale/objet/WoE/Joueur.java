...
public class Joueur {
            ...
            switch (choix) {
                case 1 -> {
                    ...
                    while (!deplacementValide) {
                        System.out.println("Choisissez une direction pour vous deplacer :");
                        ...
                        if (nouvellePos != null && World.estDeplacementValide(nouvellePos)) {
                            ...
                            System.out.println("Vous vous êtes deplace en " + nouvellePos.getX() + "," + nouvellePos.getY() + ".");
                ...
                case 2 -> {
                    ...
                    if (cible == null) {
                        System.out.println("Pas de cible a portee ou choix invalide. Vous ne pouvez pas attaquer.");
                    } else {
                ...
                default -> {
                    System.out.println("Action non reconnue. Veuillez reessayer.");
                }
            }
    ...
    public void ramasserUtilisable(Utilisable utilisable) {
        ...
        System.out.println("Vous avez ramasse : " + utilisable);
